...
<div style="margin-bottom: 40px;">
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; background: #fafafa;" border="1">
		<thead>
			<tr>
		...
		<tfoot>
			...
			if ( $item_totals ) {
				...
				foreach ( $item_totals as $total ) {
					...
					?>
					<tr>
						<td class="td subtotal_items_wrapper" scope="row" colspan="3">
							<table class="subtotal_items" width="100%">
								<tr>
								<th width="50%" class="td" scope="row" style="text-align:left; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?>"><?php echo wp_kses_post( $total['label'] ); ?></th>
								<td width="50%" class="td" style="text-align:right; <?php echo ( 1 === $i ) ? 'border-top-width: 4px;' : ''; ?> max-width: 100px;"><?php echo wp_kses_post( $total['value'] ); ?></td>
								</tr>	
							</table>
						</td>
					</tr>
