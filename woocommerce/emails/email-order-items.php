...
foreach ( $items as $item_id => $item ) :
	...
	if ( is_object( $product ) ) {
		...
		$image         = $product->get_image( wc_get_image_size( 'shop_thumbnail' ) );
	}
	...
	line-height: 1.3em; padding: 0;">
		...
		<td class="td" style="text-align:<?php echo esc_attr( $text_align ); ?>; vertical-align:middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; text-align: right; max-width: 100px;">
