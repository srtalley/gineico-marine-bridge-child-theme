			...
			<tr class="order_item">
				<?php if ( get_option( 'ywraq_show_preview' ) === 'yes' ) : ?>
					<td scope="col" class="td" style="text-align:center;border: 1px solid #eee;">
						...
						?>
						<a href="<?php echo esc_url( $_product->get_permalink() ); ?>"><img src="<?php echo esc_url( $src ); ?>"
																				 height="<?php echo esc_attr( $height ); ?>"
																				 width="<?php echo esc_attr( $width ); ?>"/></a>
					</td>
				<?php endif ?>
				...
				<td scope="col"
					style="text-align:center;border: 1px solid #eee;"><?php echo esc_html( $item['quantity'] ); ?></td>
				<?php if ( $show_total_column ) : ?>
