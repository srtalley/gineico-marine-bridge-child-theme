...
elseif ( count( $raq_content ) === 0 ) :
	if ( 0 === $notices ) {
		...
		<!--BEGIN GM CUSTOM-->
		<a class="button wc-backward" style="margin-left: 21px;" href="<?php echo esc_url( apply_filters( 'yith_ywraq_return_to_shop_url', $shop_url ) ); ?>"><?php echo esc_html( $label_return_to_shop ); ?></a> 
		<!--END GM CUSTOM-->
		<?php
	}
else :
		...
		<table class="shop_table cart  shop_table_responsive" id="yith-ywrq-table-list">
			...
			<tr>
				...
				$shop_url = apply_filters( 'yith_ywraq_return_to_shop_url', get_option( 'ywraq_return_to_shop_url' ) );
						$label_return_to_shop = apply_filters( 'yith_ywraq_return_to_shop_label', get_option( 'ywraq_return_to_shop_label' ) );
						?>
						<a class="button wc-backward dddddss" href="<?php echo apply_filters( 'yith_ywraq_return_to_shop_url', $shop_url ); ?>"><?php echo $label_return_to_shop ?></a>
					<!--END GM CUSTOM-->  
